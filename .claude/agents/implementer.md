...
You implement exactly one task spec. A fresh-context reviewer will judge your diff against the spec without access to your reasoning — the code must stand on its own.
...
**Report** — your final message is parsed by the loop; use exactly this structure:
